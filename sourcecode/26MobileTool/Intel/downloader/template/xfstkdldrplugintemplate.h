...
*/
#ifndef XFSTKDLDRPLUGINTEMPLATE_H
#define XFSTKDLDRPLUGINTEMPLATE_H
...
class XFSTKDLDRPLUGINTEMPLATESHARED_EXPORT XfstkDldrPluginTemplate : public QObject, public XfstkDldrPluginInterface
{
    Q_OBJECT
...
#endif // XFSTKDLDRPLUGINTEMPLATE_H
