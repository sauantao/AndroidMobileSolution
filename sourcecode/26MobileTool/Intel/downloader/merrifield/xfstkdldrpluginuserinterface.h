...
#ifdef XFSTK_OS_WIN
    DevicesCallBack CallbackStructMerr;
    DevicesCallBack CallbackStructMoor;
    DevicesCallBack CallbackStructCRC;
#endif
    SoCDevices socDevsMerr;
    SoCDevices socDevsMoor;
    SoCDevices socDevsCRC;
