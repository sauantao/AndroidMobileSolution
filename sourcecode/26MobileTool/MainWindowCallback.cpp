	...
	QObject(parent),main_window(window)
{
	...
	//main_window->ui->label->setText("gggggggggg");
	//InstallSignals();
}
...
void MainWindowCallback::slot_UpdateTimeLabel()
{
	...
	//cuong
	//main_window->ui->textEdit_Log->append(QString::number(seconds / 60) + ":" + zero + QString::number(seconds % 60));
	//cuong
}
...
void MainWindowCallback::UpdateSpeedLabel(U64 bytes)
{
	...
	//cuong
	//main_window->ui->textEdit_Log->append(speedInfo.c_str());
	//main_window->ui->textEdit_Log->append(totalByte.c_str());
	//cuong
}
...
//	{
//		main_window->ui->progressBar->setStyleSheet(PColorDarkCyan);//(PColorRed);
//		main_window->ui->progressBar->setValue(0);
//		main_window->ui->progressBar->setFormat(tr("Dang nap DA %1").arg(0));
//		speed_clock.restart();
//
//		start_clock.restart();
...
//		main_window->ui->progressBar->setFormat(tr("Dang nap DA %1%").arg(percent));
//		main_window->ui->textEdit_Log->append(">>  Dang nap DA ");
...
//		main_window->ui->progressBar->setValue(0);
//		main_window->ui->progressBar->setFormat(tr("26mobile-Format %1%").arg(0));
//		LOG("26mobile-The storage_type is %d, The begin_addr is %016llx, The length is %016llx.", storage_type, begin_addr, length);
//		//cuong
//		//main_window->ui->textEdit_Log->append(">> Format to: ");
//		main_window->ui->textEdit_Log->append("26mobile-The storage_type is %d, The begin_addr is %016llx, The length is %016llx.");
//		//cuong
//		usr_arg = 0;
//		Q_UNUSED(usr_arg);
//	}
...
//		main_window->ui->progressBar->setFormat(tr("Dang Format %1%").arg(finished_percentage));
//		usr_arg = 0;
//		Q_UNUSED(usr_arg);
//	}
//}
...
//		main_window->ui->progressBar->setValue(0);
//		main_window->ui->progressBar->setFormat(tr("Dang 1 Download Boot Loader %1%").arg(0));
//		speed_clock.restart();
//		usr_arg = 0;
//		Q_UNUSED(usr_arg);
//	}
...
//	{
//		main_window->ui->progressBar->setValue(finished_percentage);
//		main_window->ui->progressBar->setFormat(tr("Dang Download Boot Loader %1%").arg(finished_percentage));
...
//		main_window->ui->progressBar->setValue(0);
//		main_window->ui->progressBar->setFormat(tr("1 dang Download Brom load %1%").arg(0));
//		usr_arg = 0;
//		Q_UNUSED(usr_arg);
//	}
//}
...
//		main_window->ui->progressBar->setValue(0);
//		main_window->ui->progressBar->setFormat(tr("Dang Download Flash %1%").arg(0));
//		//cuong
//		main_window->ui->textEdit_Log->append(">> Star Download Flash ");
//		//cuong
//		speed_clock.restart();
//		usr_arg = 0;
//		Q_UNUSED(usr_arg);
...
//	{
//		main_window->ui->progressBar->setValue(finished_percentage);
//		main_window->ui->progressBar->setFormat(tr("1 dang Download Flash %1%").arg(finished_percentage));
//		//cuong
//		//main_window->ui->textEdit_Log->append(">> Star Download Flash 2");
//		//cuong
//		this->UpdateSpeedLabel(finished_bytes);
//		total_bytes = 0;
//		usr_arg = 0;
...
//		main_window->ui->progressBar->setValue(0);
//		main_window->ui->progressBar->setFormat(tr("Dang Read back %1%").arg(0));
//		speed_clock.restart();
//
//		QString tip;
//		switch (storage)
...
//	{
//		main_window->ui->progressBar->setValue(finished_percentage);
//		main_window->ui->progressBar->setFormat(tr("1dang Read back %1%").arg(finished_percentage));
//		this->UpdateSpeedLabel(finished_bytes);
//		total_bytes = 0;
//		usr_arg = 0;
//		Q_UNUSED(total_bytes);
...
//		main_window->ui->progressBar->setFormat(tr("Dang Write Memory %1%").arg(0));
//		main_window->ui->progressBar->setValue(0);
//		speed_clock.restart();
//	}
//}
...
//	{
//		main_window->ui->progressBar->setValue(percent);
//		main_window->ui->progressBar->setFormat(tr("1 dang Write Memory %1%").arg(percent));
//		this->UpdateSpeedLabel(sent_bytes);
//		total_bytes = 0;
//		usr_arg = 0;
//		Q_UNUSED(total_bytes);
...
{
	main_window->ui->progressBar->setValue(finished_percentage);
	main_window->ui->progressBar->setFormat(tr("Dang CheckSum %1 %2%").arg(imageName).arg(finished_percentage));
	this->UpdateSpeedLabel(finished_bytes);
	total_bytes = 0;
	usr_arg = 0;
	Q_UNUSED(total_bytes);
